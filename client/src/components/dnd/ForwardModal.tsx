...
export default function ForwardModal() {
  ...
  const preSelectedRoomId = useAppSelector(
    (state) => state.ui.forwardTargetRoomId,
  );
      ...
      >
        {availableConversations.map((conv) => {
          const otherParticipants =
            conv.participantUsers?.filter((p) => p.id !== currentUser?.id) ||
            [];
          const displayName =
